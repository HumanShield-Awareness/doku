---
title: "NIS2 und BSI"
description: "Wie SentryMail Awareness-Anforderungen aus NIS2 und BSI IT-Grundschutz unterstützt."
sidebar:
  order: 4
---

Wie SentryMail Awareness-Anforderungen aus **NIS2** und dem **BSI IT-Grundschutz** unterstützt.
...
2. **Rechtliches klären**: Datenschutz und ggf. Betriebsrat/Personalvertretung **vor** dem Start einbeziehen; Datensparsamkeit beachten (siehe [Sicherheit](/reference/sicherheit/)).
...
Siehe auch: [Funktionen](/reference/funktionen/) · [Sicherheit](/reference/sicherheit/)
